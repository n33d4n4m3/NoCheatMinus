...
execute as @a[tag=VE.PlayerMoveEvent] if score @s VE.PlayerMoveEvent.toPitch matches 9001.. run tellraw @s[scores={ncmInputR=1}] ["",{"text":"NCM","color":"red"},{"text":": ","color":"white"},{"selector":"@s","color":"white"},{"text":" failed WrongTurn: tried to turn wrongly from ","color":"white"},{"score":{"name":"@s","objective":"VE.PlayerMoveEvent.fromPitch"}},{"text":" to ","color":"white"},{"score":{"name":"@s","objective":"VE.PlayerMoveEvent.toPitch"}},{"text":".","color":"white"}]
