...
execute as @e[type=minecraft:player] if score @s playerHealth > @s calcFall if score @s noFallField1 matches 3.. run scoreboard players set @s ncmFailedMVMAP 0
...
execute as @e[type=minecraft:player] if score @s hasSpeedEffI matches 0 if score @s hasSpeedEffII matches 0 if score @s walkOneCm >= DataHolder ncmc_ap_ws_1 if score @s standsOnIce matches 0 run scoreboard players set @s ncmFailedMVMAP 1
execute as @e[type=minecraft:player] if score @s hasSpeedEffI matches 0 if score @s hasSpeedEffII matches 0 if score @s walkOneCm >= DataHolder ncmc_ap_ws_2 if score @s standsOnIce matches 1 run scoreboard players set @s ncmFailedMVMAP 1
...
execute as @e[type=minecraft:player] if score @s hasSpeedEffI matches 1.. if score @s walkOneCm >= DataHolder ncmc_ap_ws_3 if score @s standsOnIce matches 0 run scoreboard players set @s ncmFailedMVMAP 1
execute as @e[type=minecraft:player] if score @s hasSpeedEffI matches 1.. if score @s walkOneCm >= DataHolder ncmc_ap_ws_4 if score @s standsOnIce matches 1 run scoreboard players set @s ncmFailedMVMAP 1
execute as @e[type=minecraft:player] if score @s hasSpeedEffII matches 1.. if score @s walkOneCm >= DataHolder ncmc_ap_ws_5 if score @s standsOnIce matches 0 run scoreboard players set @s ncmFailedMVMAP 1
execute as @e[type=minecraft:player] if score @s hasSpeedEffII matches 1.. if score @s walkOneCm >= DataHolder ncmc_ap_ws_6 if score @s standsOnIce matches 1 run scoreboard players set @s ncmFailedMVMAP 1
...
execute as @e[type=minecraft:player] if score @s invVLSprint >= DataHolder ncmc_ap_sp_8 run scoreboard players set @s ncmFailedMVMAP 1
...
execute as @e[type=minecraft:player] unless score @s lostWalkFP matches 1.. if score @s hasSpeedEffI matches 0 if score @s hasSpeedEffII matches 0 if score @s sneakOneCm >= DataHolder ncmc_ap_sn_3 run scoreboard players set @s ncmFailedMVMAP 1
...
execute as @e[type=minecraft:player] unless score @s lostWalkFP matches 1.. if score @s hasSpeedEffI matches 1.. if score @s sneakOneCm >= DataHolder ncmc_ap_sn_4 run scoreboard players set @s ncmFailedMVMAP 1
...
execute as @e[type=minecraft:player] unless score @s lostWalkFP matches 1.. if score @s hasSpeedEffII matches 1.. if score @s sneakOneCm >= DataHolder ncmc_ap_sn_5 run scoreboard players set @s ncmFailedMVMAP 1
