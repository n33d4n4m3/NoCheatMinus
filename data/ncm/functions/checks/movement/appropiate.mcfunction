...
execute as @e[type=minecraft:player] if score @s playerHealth > @s calcFall if score @s noFallField1 matches 3.. run tellraw @a ["",{"text":"NCM","color":"red"},{"text":": ","color":"white"},{"selector":"@s","color":"white"},{"text":" failed "},{"text":"Appropiate"},{"text":": "},{"text":"received less ("},{"score":{"name":"@s","objective":"calcHealth"}},{"text":" HP)"},{"text":" damage after falling "},{"score":{"name":"@s","objective":"fall"}},{"text":" cm than appropiate ("},{"score":{"name":"@s","objective":"storeHealth"}},{"text":" HP)."}]
