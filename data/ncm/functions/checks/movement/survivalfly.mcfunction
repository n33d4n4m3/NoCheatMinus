...
execute as @e[type=minecraft:player] if score @s ncmSFLG_ivl >= DataHolder ncmc_sf_lg_1 unless score @s ncmAviate matches 1.. run scoreboard players set @s ncmFailedMVMSF 1
...
execute as @a if score @s ncmOffGrTicks >= DataHolder ncmc_sf_og_1 run scoreboard players set @s ncmFailedMVMSF 1
...
execute as @e[type=minecraft:player,nbt={OnGround:0b},gamemode=!creative] unless score @s ncmYSpeed matches 0 if score @s ncmYSpMaintainRC = DataHolder ncmc_sf_cr_2 if score @s ncmLastYSpeed = @s ncmYSpeed run scoreboard players set @s ncmFailedMVMSF 10
