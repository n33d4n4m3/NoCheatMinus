...
execute as @a if score @s ncmLeaveGame matches 1.. run scoreboard players reset @s ncmTicksNeededToDecend
...
execute as @a if score @s ncmLeaveGame matches 1.. store result score @s ncmTicksUntilNextLatencyCheck run random value 500..800

execute as @a unless score @s ncmLastLatencyLevel matches 0.. run scoreboard players set @s ncmLastLatencyLevel 21
execute as @a unless score @s ncmLastLatencyLevel matches 0.. store result score @s ncmTicksUntilNextLatencyCheck run random value 500..800



execute as @a unless score @s ncmTicksUntilNextLatencyCheck matches 0..10000 store result score @s ncmTicksUntilNextLatencyCheck run random value 2000..4000
