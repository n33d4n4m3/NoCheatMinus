...
execute as @a[tag=ncmePlayerMoveEvent] if score @s ncmePlayerMoveEvent.hasXZChanged matches 1 run scoreboard players set @s ncmTicksUntilVelocityUsed 0
...
execute as @a if score @s ncmePlayerMoveEvent.hasXZChanged matches 1 run scoreboard players set @s ncmVelocityStackingTest 0
execute as @a at @s if score @s ncmVelocityStackingTest matches 1 run tp @s ~ ~0.3 ~
execute as @a if score @s ncmVelocityStackingTest matches 3 if score @s ncmePlayerMoveEvent.hasDescended matches 1 if score DataHolder ncmc_cv_2 matches 1 run scoreboard players set @s ncmFailedFCV 5
execute as @a if score @s ncmVelocityStackingTest matches 3 if score @s ncmePlayerMoveEvent.hasDescended matches 1 if score DataHolder ncmc_cv_2 matches 1 if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"","color":"light_purple"},{"text":"","color":"light_purple"},{"text":"Fight","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"CompliantVelocity","color":"light_purple"},{"text":" {...}","color":"gray"}]
execute as @a if score @s ncmVelocityStackingTest matches 3 if score @s ncmePlayerMoveEvent.hasDescended matches 1 if score DataHolder ncmc_cv_2 matches 1 run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"","color":"light_purple"},{"text":"","color":"light_purple"},{"text":"Fight","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"CompliantVelocity","color":"light_purple"},{"text":" {...}","color":"gray"}]
