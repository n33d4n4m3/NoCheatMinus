...
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s VE.PlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 9
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s VE.PlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Boat}","color":"gray"}]
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s VE.PlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Boat}","color":"gray"}]
...
execute as @a[tag=VE.PlayerMoveEvent] if score @s VEGbl.thePlayer.currentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 9
execute as @a[tag=VE.PlayerMoveEvent] if score @s VEGbl.thePlayer.currentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SprintFL","color":"light_purple"},{"text":" {...}","color":"gray"}]
execute as @a[tag=VE.PlayerMoveEvent] if score @s VEGbl.thePlayer.currentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SprintFL","color":"light_purple"},{"text":" {...}","color":"gray"}]
execute as @a[tag=VE.PlayerMoveEvent] if score @s VEGbl.thePlayer.currentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run scoreboard players set @s VE.PlayerMoveEvent.willModify 1
