...
execute as @e[type=minecraft:player,nbt={OnGround:1b}] at @s unless entity @e[type=minecraft:skeleton_horse,distance=..2] unless entity @e[type=minecraft:camel,distance=..7] unless entity @e[type=minecraft:pig,distance=..2] unless entity @e[type=minecraft:horse,distance=..2] unless score @s ncmSpoofIsWaiting matches 1 if score @s ncmAirAround matches 1 run scoreboard players set @s ncmSpoofWaitLatencyTicks 3
...
execute as @e[type=minecraft:player,nbt={OnGround:0b},gamemode=!creative,gamemode=!spectator] at @s unless entity @e[type=minecraft:skeleton_horse,distance=..2] unless entity @e[type=minecraft:camel,distance=..2] unless entity @e[type=minecraft:pig,distance=..2] unless entity @e[type=minecraft:horse,distance=..2] unless score @s ncmLadderNearby matches 1.. unless score @s ncmLiquidNearby matches 1.. run scoreboard players add @s ncmYSpMaintainRC 1
