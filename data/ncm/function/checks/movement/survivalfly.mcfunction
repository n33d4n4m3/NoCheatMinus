...
execute as @e[type=minecraft:player] if score @s ncmSFLG_ivl >= DataHolder ncmc_sf_lg_1 unless score @s ncmFPBurst matches 1.. unless score @s ncmCobwebNearby matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"LostGround","color":"light_purple"},{"text":" {","color":"gray"},{"score":{"name":"@s","objective":"ncmYMotion"},"color":"gray"},{"text":"}","color":"gray"}]
...
execute as @a at @s unless score @s ncmLevitate matches 1.. if block ~ ~-0.01 ~ water if score @s ncmMVMSFWWFlagCount matches 10.. unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 5
execute as @a at @s unless score @s ncmLevitate matches 1.. if block ~ ~-0.01 ~ water if score @s ncmMVMSFWWFlagCount matches 10.. unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"LiquidGravity","color":"light_purple"},{"text":" {","color":"gray"},{"score":{"name":"@s","objective":"ncmMVMSFWWMotionY"},"color":"gray"},{"text":"}","color":"gray"}]
execute as @a at @s unless score @s ncmLevitate matches 1.. if block ~ ~-0.01 ~ water if score @s ncmMVMSFWWFlagCount matches 10.. unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"LiquidGravity","color":"light_purple"},{"text":" {","color":"gray"},{"score":{"name":"@s","objective":"ncmMVMSFWWMotionY"},"color":"gray"},{"text":"}","color":"gray"}]

execute as @a if score @s ncmMVMSFWWFlagCount matches 1.. run scoreboard players add @s ncmMVMSFWWFlagCountRC 1
execute as @a if score @s ncmMVMSFWWFlagCount matches 10.. run scoreboard players set @s ncmMVMSFWWFlagCount 0
execute as @a if score @s ncmMVMSFWWFlagCount matches 10.. run scoreboard players set @s ncmMVMSFWWFlagCountRC 0
...
#execute as @a if score @s ncmSFJCR > DataHolder ncmc_sf_jc_1 unless score @s ncmSFPlayerLatencyFP matches 1.. unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 9
#execute as @a if score @s ncmSFJCR > DataHolder ncmc_sf_jc_1 unless score @s ncmSFPlayerLatencyFP matches 1.. unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"JumpCount","color":"light_purple"},{"text":" {...}","color":"gray"}]
#execute as @a if score @s ncmSFJCR > DataHolder ncmc_sf_jc_1 unless score @s ncmSFPlayerLatencyFP matches 1.. unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"JumpCount","color":"light_purple"},{"text":" {...}","color":"gray"}]
...
execute as @a if score @s ncmePlayerMoveEvent.hasDescended matches 1 run scoreboard players set @s ncmSFOGFailCountForLatencyBuffer 0
execute as @a if score @s ncmePlayerMoveEvent.hasDescended matches 1 run scoreboard players set @s ncmSFOGFailCountForLatencyBufferR 0
...
execute as @a[gamemode=!spectator,gamemode=!creative] if score @s ncmePlayerMoveEvent.hasClimbed matches 1 unless score @s ncmClimbedWaitForLegitimation matches 1.. if score @s ncmePlayerMoveEvent.distanceVertical matches 1.. unless score @s ncmIgnoreFurtherClimb matches 1 run scoreboard players set @s ncmFlagLastClimb 1
...
#execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 run tellraw @s {"score":{"name":"@s","objective":"ncmePlayerMoveEvent.distanceVertical"}}
execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 if score @s ncmClimbFlagCount matches 0 run scoreboard players operation @s ncmLastXBeforeClimb = @s ncmePlayerMoveEvent.fromX
execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 if score @s ncmClimbFlagCount matches 0 run scoreboard players operation @s ncmLastYBeforeClimb = @s ncmePlayerMoveEvent.fromY
execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 if score @s ncmClimbFlagCount matches 0 run scoreboard players operation @s ncmLastZBeforeClimb = @s ncmePlayerMoveEvent.fromZ
execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 if score @s ncmClimbFlagCount matches 0 run scoreboard players operation @s ncmLastYawBeforeClimb = @s ncmePlayerMoveEvent.fromYaw
execute as @a if score @s ncmFlagLastClimb matches 1 unless score @s ncmIgnoreFurtherClimb matches 1 if score @s ncmClimbFlagCount matches 0 run scoreboard players operation @s ncmLastPitchBeforeClimb = @s ncmePlayerMoveEvent.fromPitch
...
execute as @a at @s if entity @e[type=minecraft:zombie_horse,distance=..2] run scoreboard players set @s ncmClimbedWaitForLegitimation 0
...
execute as @a at @s if entity @e[type=minecraft:donkey,distance=..2] run scoreboard players set @s ncmClimbedWaitForLegitimation 0
execute as @a at @s if entity @e[type=minecraft:area_effect_cloud,distance=..15] run scoreboard players set @s ncmClimbedWaitForLegitimation 0
...
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"UnexpectedClimb","color":"light_purple"},{"text":" {...","color":"gray"},{"text":"}","color":"gray"}]
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run scoreboard players operation @s ncmePlayerMoveEvent.modX = @s ncmLastXBeforeClimb
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run scoreboard players operation @s ncmePlayerMoveEvent.modY = @s ncmLastYBeforeClimb
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run scoreboard players operation @s ncmePlayerMoveEvent.modZ = @s ncmLastZBeforeClimb
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run scoreboard players operation @s ncmePlayerMoveEvent.modYaw = @s ncmLastYawBeforeClimb
execute as @a if score @s ncmClimbFlagCount matches 2 unless score DataHolder ncmMVMTSLagTimeout matches 1.. run scoreboard players operation @s ncmePlayerMoveEvent.modPitch = @s ncmLastPitchBeforeClimb
#execute as @a if score @s ncmClimbFlagCount matches 2 run scoreboard players set @s ncmePlayerMoveEvent.willModify 1
...
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 9
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Boat}","color":"gray"}]
execute as @e[type=minecraft:player] if score @s ncmBoat matches 1.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Boat}","color":"gray"}]


execute as @e[type=minecraft:player] if score @s ncmeCurrentMovementState matches 10 run scoreboard players add @s ncmSFClimbAviateGrace 1
execute as @e[type=minecraft:player] unless score @s ncmeCurrentMovementState matches 10 run scoreboard players set @s ncmSFClimbAviateGrace 0
execute as @a if items entity @s weapon firework_rocket run scoreboard players set @s ncmSFClimbAviateGrace 1
#execute as @e[type=minecraft:player] if score @s ncmSFClimbAviateGrace matches 80.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 if score @s ncmePlayerMoveEvent.hasXZChanged matches 0 run scoreboard players set @s ncmFailedMVMSF 9
#execute as @e[type=minecraft:player] if score @s ncmSFClimbAviateGrace matches 80.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 if score @s ncmePlayerMoveEvent.hasXZChanged matches 0 if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Aviate}","color":"gray"}]
#execute as @e[type=minecraft:player] if score @s ncmSFClimbAviateGrace matches 80.. if score @s ncmePlayerMoveEvent.hasClimbed matches 1 if score @s ncmePlayerMoveEvent.hasXZChanged matches 0 run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"Climb","color":"light_purple"},{"text":" {Aviate}","color":"gray"}]
...
execute as @a[tag=ncmePlayerMoveEvent] if score @s ncmeCurrentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmFailedMVMSF 9
execute as @a[tag=ncmePlayerMoveEvent] if score @s ncmeCurrentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. if score @s ncmVerbose matches 2 run tellraw @a[scores={ncmInputR=1}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SprintFL","color":"light_purple"},{"text":" {...}","color":"gray"}]
execute as @a[tag=ncmePlayerMoveEvent] if score @s ncmeCurrentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run tellraw @a[scores={ncmInputR=2}] ["",{"text":"NCM","color":"dark_gray"},{"text":": ","color":"gray"},{"selector":"@s","color":"gray"},{"text":">> ","color":"gray"},{"text":"Movement","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SurvivalFly","color":"light_purple"},{"text":".","color":"light_purple"},{"text":"SprintFL","color":"light_purple"},{"text":" {...}","color":"gray"}]
execute as @a[tag=ncmePlayerMoveEvent] if score @s ncmeCurrentMovementState matches 2 if score @s ncmFoodLevelGraceT >= @s ncmIndividualFoodLevelGrace unless score @s ncmFPBurst matches 1.. run scoreboard players set @s ncmePlayerMoveEvent.willModify 1
