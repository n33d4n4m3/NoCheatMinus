...
execute as @a[tag=VE.PlayerMovementStateTransitionEvent,tag=VE.PlayerAttackEvent] if score @s VE.PlayerMovementStateTransitionEvent.priorMovementState matches 2 if score @s VE.PlayerMovementStateTransitionEvent.newMovementState matches 1 run scoreboard players set @s ncmMightStillSprinting 1
execute as @a if score @s VEGbl.thePlayer.currentMovementState matches 2 run scoreboard players set @s ncmMightStillSprinting 0


# Movement State 1 -> WALKING
execute as @e[type=minecraft:player,tag=VE.PlayerMoveEvent] unless score @s ncmMightStillSprinting matches 1 unless score @s ncmTicksNoMovementPacketsProcessed matches 1.. unless score @s ncmTimesStrideTooHighWithLatency matches 1.. unless score @s ncmTSTransitionTimeout matches 1.. unless score @s ncmTSIceTimeout matches 1.. unless score DataHolder ncmMVMTSLagTimeout matches 1.. if score @s VE.PlayerMoveEvent.hasPositionChanged matches 1 if score @s VEGbl.thePlayer.currentMovementState matches 1 if score @s VE.PlayerMoveEvent.distanceHorizontal > DataHolder ncmc_ts_1 run scoreboard players add @s ncmTimesStrideTooHighLog 1
...
execute as @e[type=minecraft:player,tag=VE.PlayerMoveEvent] unless score @s ncmTicksNoMovementPacketsProcessed matches 1.. unless score @s ncmTimesStrideTooHighWithLatency matches 1.. unless score @s ncmTSTransitionTimeout matches 1.. unless score @s ncmTSIceTimeout matches 1.. unless score DataHolder ncmMVMTSLagTimeout matches 1.. if score @s VE.PlayerMoveEvent.hasPositionChanged matches 1 if score @s ncmMightStillSprinting matches 1 if score @s VE.PlayerMoveEvent.distanceHorizontal > DataHolder ncmc_ts_3 run scoreboard players add @s ncmTimesStrideTooHighLog 1
...
execute as @e[type=minecraft:player,tag=VE.PlayerMoveEvent] unless score @s ncmTicksNoMovementPacketsProcessed matches 1.. unless score @s ncmTimesStrideTooHighWithLatency matches 1.. unless score @s ncmTSTransitionTimeout matches 1.. unless score @s ncmTSIceTimeout matches 1.. unless score DataHolder ncmMVMTSLagTimeout matches 1.. if score @s VE.PlayerMoveEvent.hasPositionChanged matches 1 if score @s ncmMightStillSprinting matches 1 if score @s VE.PlayerMoveEvent.distanceHorizontal > DataHolder ncmc_ts_4 run scoreboard players add @s ncmTimesStrideTooHighCancel 1
